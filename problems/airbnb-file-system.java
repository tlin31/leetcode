...
Output:
fileSystem.create( a , 1) --> false
fileSystem.create(/a, 1)--> true
fileSystem.create(/a/b, 2) -->true
fileSystem.create(/c/b, 3) -->false
on path /a/b
on path /a
fileSystem.create(/a/b/c, 2) -->true
fileSystem.get(/a/b/c) -->2
fileSystem.get(/a/b/c/d) -->null
