...
//use the first row and column of the matrix itself to store "zeroing" flags. We use one extra variable to track if the very first column originally had a zero
