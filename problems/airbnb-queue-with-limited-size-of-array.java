Airbnb - Implement Queue with Limited Size of Arrays


/*
Assumption:
1. Implement a queue using many arrays, array size has to be < 5
...
public class CQueueWithFixedArray {
    ...
    class MyQueue {
        ...
        // always go from 0 to 4
        private int head;
        private int tail;

        // use to check if empty queue when poll
        private int count;
